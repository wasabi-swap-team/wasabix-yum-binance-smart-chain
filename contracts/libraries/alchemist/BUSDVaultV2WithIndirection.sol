...
library BUSDVaultV2WithIndirection {
  using BUSDVaultV2WithIndirection for Data;
  using BUSDVaultV2WithIndirection for List;
  using SafeMath for uint256;

  struct Data {
    IBUSDVaultAdapterV2WithIndirection adapter;
